...
class FunctionHelper:
    ...
    def get_true_max(self):
        ...
        elif (self.true_func_type == 'BRN2D'):
        ...
        elif (self.true_func_type == 'ACK2D'):
        ...
        elif (self.true_func_type == 'MIC2D'):
            true_max = self.get_true_func_value([2.20446091, 1.56922396])[0]
